...
palabras_array.push("BANANO");
palabras_array.push("MARACUYA");
palabras_array.push("LIMON");
palabras_array.push("MANGO");
palabras_array.push("SANDIA");
palabras_array.push("KIWI");
palabras_array.push("NARANJA");
palabras_array.push("MANDARINA");
palabras_array.push("FRESA");
palabras_array.push("GRANADILLA");
palabras_array.push("PAPAYA");
palabras_array.push("COCO");
...
function gameOver(errores){
    ...
    if (errores < 5){
        ctx.fillText("Ganaste!!, la palabra es: ", 110, 280);
    } else {
